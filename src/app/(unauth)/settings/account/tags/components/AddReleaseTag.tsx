  ...
  return (
    <div className="w-full mt-6">
      ...
      {/* {
        isEditingReleaseTag &&
        <Button
          className="text-black bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-hidden focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ml-4"
          onClick={resetForm}
          disabled={isSaving}
        >
          Cancel
